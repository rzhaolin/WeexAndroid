...
function generateData(sentence) {
  return sentence.split('').map(function (type, index) {
    ...
    return {
      ...
      label: type,
      imgSrc: img1,
      txt: '点击图片:测试从子卡片获取item数据，console.error打印了信息',
      height: '100px',
      width: '400px'
    };
  });
...
__vue_options__.__file = "/Users/rizhao.lin/Documents/work/linrizhao/weex/vue/helloworld/src/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
